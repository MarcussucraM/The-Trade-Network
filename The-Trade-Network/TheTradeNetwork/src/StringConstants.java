public interface StringConstants {
	...
	final static String[] tradeHistoryColumns = {"Trader","Item","Offerer","Item Offered", "DateOfOffer","DateAccepted"};
	...
	final static String[] offerInformationColumns = {"You","Trading","With User","For","Phone","Street","City","State"};
